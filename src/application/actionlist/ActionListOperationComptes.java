...
public class ActionListOperationComptes implements ActionList {
	...
	public ActionListOperationComptes() {
		this.message="Menu opérations sur comptes";
		this.code="3";
		...
		this.myMenu.add(new ActionDeposerArgentSurCompte());
		this.myMenu.add(new ActionRetirerArgentSurCompte());
